...
Vagrant.configure("2") do |config|
  ...
  # port forwarding for ubuntu-20.04-dev bootstrap environments

  # JupyterHub/JupyterLab is being served at port 8000 if jupyterhub bootstraped
  ...
  config.vm.provision "shell", path: "./scripts/bootstrap-anaconda3-python.sh"
  config.vm.provision "shell", path: "./scripts/bootstrap-jupyterhub-server.sh"
end
